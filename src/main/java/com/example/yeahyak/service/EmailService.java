...
public class EmailService {
    ...
    private  static String[] receiveList = {"uzjaee@gmail.com", "kyj960802@gmail.com"};
    ...
    public void sendCancellationEmail(StatusForm dto) {
        // 예약 취소 관련 이메일 전송 로직
        SimpleMailMessage simpleMailMessage = new SimpleMailMessage();
        try {
            simpleMailMessage.setTo(receiveList);
            simpleMailMessage.setSubject("예약을 취소했습니다.");
